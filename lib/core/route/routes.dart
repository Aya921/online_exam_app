      ...
      case AppRoutes.startExam:
        ...
        return MaterialPageRoute(
          builder: (context) => StartExamPage(
            exam: args[PageConstants.examArg],
            subjectName: args[PageConstants.subjectNameArg],
          ),
        );
      ...
      case AppRoutes.score:
        ...
        return MaterialPageRoute(
          builder: (context) => ScorePage(
            qustionList: arg![PageConstants.questionListArg] as List<QuestionsModel>,
            studentanswers: arg[PageConstants.studentAnswerArg] as List<List<String?>?>,
