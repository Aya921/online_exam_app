...
class _QuesionsPageState extends State<QuesionsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<QustionViewModel, QuestionState>(
        ...
        builder: (context, state) {
          ...
          if (state.isTimeEnd) {
            WidgetsBinding.instance.addPostFrameCallback((_) {
              showMyDialog(context,qustionViewModel,questioinsList,studentAnswers);
              state.isTimeEnd = false;
            });
          }

          if (state.questionsList != null) {
            questioinsList = state.questionsList!;
                        ...
                        children: [
                         ...
                         const  SizedBox(width: 20),
                          ...
                          InkWell(
                            ...
                            child: CustumButtom(
                              txt: qNumber == numberOfQ - 1? t.finish : t.next,
