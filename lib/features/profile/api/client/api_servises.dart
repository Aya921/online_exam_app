...
import 'package:exam_app/features/profile/api/model/change_password_respone.dart';
...
abstract class ProfileApiServises {
  ...
  Future<void> editProfile(@Body() Map<String, dynamic> profileData);

  @PATCH(Endpoints.changePassword)
  Future<ChangePasswordRespone> changePassword(@Body() ChangePasswordBody passwordData);
}
